...
namespace Tema_4_Restorant.Controllers
{
    public class TablesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Seats,isSmoker")] Table table)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Seats,isSmoker")] Table table)
        {
            if (id != table.Id)
            {
                return NotFound();
